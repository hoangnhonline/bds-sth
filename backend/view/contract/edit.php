...
$customerArr = $model->getDetail('customers', $customer_id);
...
if($_SESSION['level'] ==1 ){
    ...
    $districtArr = $model->getListDistrictIDAsset($_SESSION['user_id']);
    $string_district_id = '';
    if(!empty($districtArr)){
        foreach ($districtArr as $value) {
            $string_district_id.=$value.",";
        }
        $string_district_id = rtrim($string_district_id, ",");
        $districtArr['data'] = $model->getListByStringId('district', $string_district_id);                                
    }
}
...
$serviceSelectedArr = $model->getRelation('contract_service', 'service_id', 'contract_id', $id);
$conSelectedArr = $model->getRelation('contract_convenient', 'convenient_id', 'contract_id', $id);
$roomateID = $model->getRelation('contract_roomate', 'customer_id', 'contract_id', $id);

$roomateDetailArr = array();
if(!empty($roomateID)){
    $roomateDetailArr = $model->getListByArrId('customers', $roomateID);
}
?>
        ...
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
          ...
          <div class="panel panel-default">
            ...
            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
              <div class="panel-body">
                <div class="col-md-7" style="margin-top:20px">
                    <input type="hidden" name="customer_id" value="<?php echo $customerArr['id']; ?>">
                    <input type="hidden" name="customer_id_old" value="<?php echo $customerArr['customer_id_old']; ?>">
                    <div id="kh_new">
                        <div class="form-group">
                            <label for="name">Tên</label>
                            <input  value="<?php echo isset($customerArr['name'])  ? $customerArr['name'] : "" ?>" type="text" name="name" id="name" class="form-control required">
                        </div>
                        <div class="form-group">
                            <label>Giới tính</label>                            
                            <label class="radio-inline"><input type="radio" name="gender" id="gender_1" value="1"
                                <?php if((isset($customerArr['gender']) && $customerArr['gender'] == 1) || empty($customerArr)) { echo "checked"; } ?>
                                >Nam</label>
                            <label class="radio-inline"><input type="radio" name="gender" id="gender_2" value="2"
                                <?php if(isset($customerArr['gender']) && $customerArr['gender'] == 2) echo "checked"; ?>
                                >Nữ</label>
                        </div>
                        <div class="form-group">
                            <label for="name">Điện thoại</label>
                            <input  value="<?php echo isset($customerArr['phone'])  ? $customerArr['phone'] : "" ?>" type="text" name="phone" id="phone" class="form-control required">
                        </div>

                        <div class="form-group">
                            <label for="name">Email</label>
                            <input  value="<?php echo isset($customerArr['email'])  ? $customerArr['email'] : "" ?>" type="text" name="email" id="email" class="form-control">
                        </div>

                        <div class="form-group">
                            <label for="name">Ngày sinh</label>
                            <input  value="<?php echo isset($customerArr['birthday'])  ? $customerArr['birthday'] : "" ?>" type="text" name="birthday" id="birthday" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="name">CMND</label>
                            <input  value="<?php echo isset($customerArr['cmnd'])  ? $customerArr['cmnd'] : "" ?>" type="text" name="cmnd" id="cmnd" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="name">Địa chỉ/Quê quán</label>
                            <textarea  name="address" id="address" class="form-control" rows="3"><?php echo isset($customerArr['address'])  ? $customerArr['address'] : "" ?></textarea>
                        </div>   
                    </div>                    
                </div>
              </div>
              ...
              <div class="panel-body">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control selectpicker" id="no_month" name="no_month" data-live-search="true">                                    
                            <?php for($i=1; $i<=60; $i++){ ?>
                            <option value="<?php echo $i; ?>"
                                <?php if($detail['no_month']==$i) echo "selected" ; ?>
                            >
                                <?php 
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input  value="<?php echo isset($detail['price'])  ? number_format($detail['price']) : $detailTaiSan['price_1']; ?>" type="text" name="price" id="price" readonly="true" class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
					<?php //var_dump($detail['deposit_date']); ?>
                        <label for="name">Ngày đặt cọc</label>
                        <input  value="<?php  echo (isset($detail['deposit_date']) && $detail['deposit_date']!='0000-00-00' && $detail['deposit_date']!='1970-01-01')  ? $detail['deposit_date'] : "" ?>
" type="text" name="deposit_date" id="deposit_date" class="form-control datepicker">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <?php if(!empty($arrServiceHouse)){ 
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-11">
                                <div class="form-group">
                                    <input type="checkbox"
                                <?php if($v['service_id'] == 1 || $v['service_id'] == 2 || in_array($v['service_id'], $serviceSelectedArr) ) echo "checked"; ?>
                    ...
                    <?php //var_dump("<pre>", $arrServiceHouse); ?>
                     <?php if(!empty($conArr)){ 
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-11">
                                <div class="form-group">
                                    <input type="checkbox" <?php if(in_array($v['id'], $conSelectedArr) ) echo "checked"; ?>                              
          ...
          <div class="panel panel-default">
            ...
            <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
              <div class="panel-body">
                ...
                <div id="roomateDiv">
                    <?php if(!empty($roomateDetailArr)){ 
                        $i = 0;
                        foreach ($roomateDetailArr as $roomate_id => $value) {
                            
                    ?>
                    <input type="hidden" name="roomate_id[]" value="<?php echo $roomate_id; ?>" />
                    <div class="col-md-12 roomate" style="border:1px solid #CCC; padding:10px;margin-bottom:15px;">                        
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="name">Tên</label>
                                <input type="text" name="name_roomate[]" value="<?php echo $value['name']; ?>" class="form-control required">
                            </div>
                        </div>                        
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Giới tính</label><br />
                                                              <label class="radio-inline"><input type="radio" name="gender_roomate_<?php echo $i; ?>"  value="1" <?php echo $value['gender']==1 ? "checked=checked" : "";?> >Nam</label>
                                <label class="radio-inline"><input <?php echo $value['gender']== 2 ? "checked" : "";?> type="radio" name="gender_roomate_<?php echo $i; ?>" value="2">Nữ</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="name">Điện thoại</label>
                                <input type="text" name="phone_roomate[]" value="<?php echo $value['phone']; ?>"  class="form-control required">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="name">Email</label>
                                <input type="email" name="email_roomate[]" value="<?php echo $value['email']; ?>"  class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="name">Ngày sinh</label>
                                <input type="text" name="birthday_roomate[]" value="<?php echo $value['birthday']; ?>"  class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="name">CMND</label>
                                <input type="text" name="cmnd_roomate[]" class="form-control" value="<?php echo $value['cmnd']; ?>" >
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="name">Địa chỉ/Quê quán</label>
                                <textarea  name="address_roomate[]" class="form-control" rows="3"><?php echo $value['address']; ?></textarea>
                            </div>  
                        </div>
                    </div>
                    <?php $i++; } } ?>
