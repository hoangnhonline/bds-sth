                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td style="white-space:nowrap">
                            <a href="index.php?mod=estate_type&act=form&id=<?php echo $row['id']; ?>">
                                <i class="fa fa-fw fa-edit"></i>
                            </a>
                            <a href="javascript:;" alias="<?php echo $row['name']; ?>" id="<?php echo $row['id']; ?>" mod="estate_type" class="link_delete" >
