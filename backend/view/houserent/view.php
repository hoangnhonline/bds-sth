...
<div class="row">   
    ...
    <div class="col-md-12">
        ...
        <button class="btn btn-default btn-sm" onclick="location.href='index.php?mod=houserent&act=list'">Quay lại</button>
        <button class="btn btn-primary btn-sm" onclick="location.href='index.php?mod=houserent&act=form&id=<?php echo $id; ?>'">Chỉnh sửa</button>
        	...
        	<div class="row">
	        	<div class="col-md-6">
		        	<table class="table table-bordered">
                        ...
                        <tr>
                            <th style='width:30%'>Hợp đồng tối thiểu</th>
                            <td><?php echo ($detail['min_contract']); ?></td>
                        </tr>
		        		<tr>
                        ...
                        <tr>
                            <th style='width:30%'>Giá thuê</th>
                            <td><?php echo number_format($detail['price']); ?></td>
                        </tr> 
                        <tr>
                            <th style='width:30%'>Đặt cọc tối thiểu</th>
