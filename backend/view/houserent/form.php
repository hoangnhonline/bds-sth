...
if($_SESSION['level']==1){
    ...
    $arrCustomList['user_id'] = $_SESSION['user_id'];    
}
...
$typeArr = $model->getList('type_bds', -1, -1, array('type' => 1));
?>
    ...
    <div class="col-md-12">
        ...
        <div style="clear:both;margin-bottom:10px"></div>
         ...
         <div class="box-header">
            ...
            <h3 class="box-title"><?php echo (isset($id) && $id > 0) ? "Cập nhật" : "Tạo mới" ?> nhà cho thuê </h3>
            <?php if($id > 0){ ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control number" name="price" id="price" value="<?php if(isset($detail['price'])) echo number_format($detail['price']); ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Hợp đồng tối thiểu<span class="required"> ( * ) </span></label>
                            <input class="form-control" name="min_contract" id="min_contract" value="<?php if(isset($detail['min_contract'])) echo $detail['min_contract']; ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Đặt cọc<span class="required"> ( * ) </span></label>
                            <input class="form-control number" name="deposit" id="deposit" value="<?php if(isset($detail['deposit'])) echo number_format($detail['deposit']); ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <br />
                            <?php foreach($purposeArr['data'] as $v) { ?>
                            <label class="checkbox-inline"><input type="checkbox" 
                                <?php if(isset($arrPurposeSelected) && in_array($v['id'], $arrPurposeSelected)) echo "checked"; ?>
                                name="purpose_id[]" value="<?php echo $v['id']; ?>">&nbsp;&nbsp;&nbsp;<?php echo $v['name']; ?></label><br />                               
                            <?php } ?>
