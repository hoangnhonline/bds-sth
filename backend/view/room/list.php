...
if($_SESSION['level']==1){
    $arrCustomList['user_id'] = -1;    
}else{
    $arrCustomList['user_id'] = $user_id;    
}
            ...
            <div class="box-body">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control select-change selectpicker show-tick" data-live-search="true" data-table="district" data-type="list" data-child="district_id" name="city_id" id="city_id">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control select-change selectpicker show-tick" data-live-search="true" data-table="ward" data-type="list" data-child="ward_id" name="district_id" id="district_id">
                                <option value="0">---Tất cả---</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control select-change selectpicker show-tick" data-live-search="true" data-table="house" data-type="list" data-child="house_id" name="ward_id" id="ward_id">
                                <option value="0">---Tất cả---</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="house_id">Nhà</label>
                            <select class="form-control selectpicker show-tick" data-live-search="true" name="house_id" id="house_id">
                                <option value="0">---Tất cả---</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="house_id">Trạng thái</label>
                            <select class="form-control selectpicker show-tick" data-live-search="true" name="status" id="status">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td align="center"><?php echo $model->getNameById('users', $row['created_by']); ?></td>
                        ...
                        <td style="white-space:nowrap">
                            ...
                            ?>
                            <a class="btn btn-sm btn-success" href="index.php?mod=room&act=view&id=<?php echo $row['id']; ?>" title="Xem chi tiết">
                                Xem chi tiết

                            </a>&nbsp;
                            <a  class="btn btn-sm btn-warning" href="index.php?mod=room&act=form&id=<?php echo $row['id']; ?>"  class="btn btn-sm btn-warning">
                                Chỉnh sửa
                            </a>
