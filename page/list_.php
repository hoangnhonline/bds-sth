 ...
 $arrDistrictDetail = array();
    ...
    <div class="clearfix"></div>
         ...
         <?php           
          ...
          $roomArr = $model->getList("objects", -1, -1, array('city_id' => $city_id, 'type_id' => $type_id, 'price_id' => $price_id, 'status' => 1));
      ...
      <div class="clearfix"></div>
         ...
         <?php           
          ...
          $roomArr = $model->getList("objects", -1, -1, array('city_id' => $city_id, 'type_id' => $type_id,'district_id' => $district_id, 'price_id' => $price_id, 'status' => 1));
